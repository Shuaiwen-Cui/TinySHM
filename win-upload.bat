...
@REM git push -f https://github.com/Shuaiwen-Cui/TinySHM.git main
git push -f https://github.com/Shuaiwen-Cui/TinySHM.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/TinySHM.git
